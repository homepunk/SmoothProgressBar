...
public class CircularProgressBar extends ProgressBar {
  ...
  public CircularProgressBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    if (isInEditMode()) {
      setIndeterminateDrawable(
          new fr.castorflex.android.circularprogressbar.CircularProgressDrawable.Builder(
              context).build());
      return;
    }
    ...
    fr.castorflex.android.circularprogressbar.CircularProgressDrawable.Builder builder =
        new fr.castorflex.android.circularprogressbar.CircularProgressDrawable.Builder(
            context).sweepSpeed(sweepSpeed)
  ...
  private fr.castorflex.android.circularprogressbar.CircularProgressDrawable checkIndeterminateDrawable() {
    Drawable ret = getIndeterminateDrawable();
    if (ret == null
        || !(ret instanceof fr.castorflex.android.circularprogressbar.CircularProgressDrawable)) {
      throw new RuntimeException("The drawable is not a CircularProgressDrawable");
    }
    return (fr.castorflex.android.circularprogressbar.CircularProgressDrawable) ret;
  }
  ...
  public void progressiveStop(
      fr.castorflex.android.circularprogressbar.CircularProgressDrawable.OnEndListener listener) {
